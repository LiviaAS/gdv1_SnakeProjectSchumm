...
void CreateMeshObj(int NumOfVertices, float* pVertices, int NumOfTriangles, int* pTriangles, BHandle& Material, BHandle& Mesh)
{
    SMeshInfo MeshInfo;
...
void CreateCubeMesh(BHandle& Mesh, BHandle& Material)
{
    ...
    CreateMeshObj(24, &s_CubeVertices[0][0], 12, &s_CubeTriangles[0][0], Material, Mesh);
}